...
if [ "$?" != "1" ]
  then
    case $opt in
      1) tput sgr0;~/scripts-13/clobber.sh;~/scripts-13/build_aicp_nosync.sh;tput setf 0; tput setb 7;;
      2) tput sgr0;~/scripts-13/clobber.sh;~/scripts-13/build_aicp_T310.sh;tput setf 0; tput setb 7;;
      3) tput sgr0;~/scripts-13/clobber.sh;~/scripts-13/build_aicp_T311_315.sh;tput setf 0; tput setb 7;;
      ...
      9) tput sgr0;~/scripts-13/clobber.sh;~/scripts-13/build.sh;tput setf 0; tput setb 7;;
      ...
      12) tput sgr0;~/scripts-13/clobber.sh;~/scripts-13/build_T315.sh;tput setf 0; tput setb 7;;
      13) tput sgr0;~/scripts-13/clobber.sh;~/scripts-13/build_T311_315.sh;tput setf 0; tput setb 7;;
      1a) tput sgr0;~/scripts-13/clobber.sh;~/scripts-13/build_bliss_nosync.sh;tput setf 0; tput setb 7;;
      2a) tput sgr0;~/scripts-13/clobber.sh;~/scripts-13/build_bliss_T310.sh;tput setf 0; tput setb 7;;
      3a) tput sgr0;~/scripts-13/clobber.sh;~/scripts-13/build_bliss_T311_315.sh;tput setf 0; tput setb 7;;
      4a) ;;
      5a) tput sgr0; ~/scripts-13/sync_only_aicp.sh;tput setf 0; tput setb 7;;
      5b) tput sgr0; ~/scripts-13/sync_only_bliss.sh;tput setf 0; tput setb 7;;
      5c) tput sgr0; ~/scripts-13/sync_only.sh;tput setf 0; tput setb 7;;
      g)  ;;
      cc) tput sgr0;~/scripts-13/clobber.sh;tput setf 0; tput setb 7;;
      m)  ;;
